...
class Product(models.Model):
    ...
    compostable = models.BooleanField(default=False,blank=True, null=True)
    nontoxic = models.BooleanField(default=False,blank=True, null=True)
    breathable = models.BooleanField(blank=True, null=True)
